...
public class EventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        feature.add(new Feature(getString(R.string.country_market), getString(R.string.market_description),
                R.drawable.events_clarens_country_market));
        feature.add(new Feature(getString(R.string.amohela_classic), getString(R.string.amohela_description),
                R.drawable.events_amohelo_classic));

        // Create an {@link FeatureAdapter}, whose data source is a list of {@link Feature}s. The
        // adapter knows how to create list items for each item in the list.
        FeatureAdapter adapter = new FeatureAdapter(getActivity(), feature, R.color.category_events);
